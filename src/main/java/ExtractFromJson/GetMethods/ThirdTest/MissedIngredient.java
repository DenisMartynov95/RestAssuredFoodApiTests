...
public class MissedIngredient {
    ...
    public MissedIngredient(int id, double amount, String unit, String unitLong, String unitShort, String aisle, String name, String original, String originalName, ArrayList<String> meta, String image, String extendedName) {
        this.id = id;
        this.amount = amount;
        this.unit = unit;
        this.unitLong = unitLong;
