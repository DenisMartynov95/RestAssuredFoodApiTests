...
public class UnusedIngredient {
    ...
    public UnusedIngredient(int id, double amount, String unit, String unitLong, String unitShort, String aisle, String name, String original, String originalName, ArrayList<Object> meta, String image) {
        this.id = id;
        this.amount = amount;
        this.unit = unit;
        this.unitLong = unitLong;
